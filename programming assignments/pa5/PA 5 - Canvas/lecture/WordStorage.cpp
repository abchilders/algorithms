...
void WordStorage::readDictionary(const string dict_file)
{
...
// on edit distance
void WordStorage::computeTopTenWords(
...
string WordStorage::recordCorrectSpelling(
	const string& next_word, 
...
void WordStorage::outputAutoCorrects(
	const string& corrections_file,
...
bool WordStorage::wordExistsInDict(const string& next_word)
{
